...
namespace Lab2deliverableFunPlaces
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.WriteLine("So " + userName + " What are you in the mood for? Please select the number of your choice from this list:");
                Console.WriteLine("");
                ...
                
                {
                    ...
                    if (select1 > 4)
                    {
                        Console.WriteLine("Sorry, try again.  Please choose (1-4)");
                        Console.WriteLine("");
                    }
                }
            }
            ...
            do
            {
                ...
                if (select2 == 3)
                {
                    Console.WriteLine("You should also definitely take a Volkswagen bus and not a clown car.");
                }
                if (select2 == 4)
                {
                ...
                if (select2 > 4)
                {
                    Console.WriteLine("Does not compute, please try again. Choose option (1-4)");
            ...
            {
                Console.WriteLine("");
                Console.WriteLine("So long, farewell, Auf Wiedersehen, goodbye!  And have a great time " + userName+ "!");
                Console.ReadKey();
            }
